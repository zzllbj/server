...
public:
  ...
  Session_tracker()
  {
    ...
    m_trackers[CURRENT_SCHEMA_TRACKER]= &current_schema_tracker;
    m_trackers[SESSION_STATE_CHANGE_TRACKER]= &session_state_change_tracker;
    m_trackers[TRANSACTION_INFO_TRACKER]= &transaction_state_tracker;
  }
